...
function optionsSideWindow1()
    if eur_player_faction.name == "russia" then
        ...
        ImGui.SetNextWindowPos(1175*eurbackgroundWindowSizeRight, 265*eurbackgroundWindowSizeBottom)
        ImGui.BeginChild("Child Window_options_subtab_2_1_side", 300*eurbackgroundWindowSizeRight, 615*eurbackgroundWindowSizeBottom)
...
function repostionAA()
    ...
    elseif alt_startAA_choice == 2 then
        ...
        aa1.character:teleport(455,347)
        aa2.character:teleport(454,348)
        aa3.character:teleport(456,348)
        aa4.character:teleport(472,326)
        aa5:teleport(454,342)
        aa6:teleport(456,342)
        M2TW.stratMap.jumpCamera(455,347)
...
function welcomeAA()
    ...
    ImGui.EndChild()
    ImGui.SetNextWindowBgAlpha(0)
    ImGui.SetNextWindowPos(730*eurbackgroundWindowSizeRight, 720*eurbackgroundWindowSizeBottom)
    ...
    ImGui.EndChild()
    ImGui.SetNextWindowBgAlpha(0)
    ImGui.SetNextWindowPos(1010*eurbackgroundWindowSizeRight, 450*eurbackgroundWindowSizeBottom)
    ...
    ImGui.EndChild()
    ImGui.SetNextWindowBgAlpha(0)
    ImGui.SetNextWindowPos(620*eurbackgroundWindowSizeRight, 500*eurbackgroundWindowSizeBottom)
    ...
    ImGui.EndChild()
    ImGui.SetNextWindowBgAlpha(0)
    ImGui.SetNextWindowPos(630*eurbackgroundWindowSizeRight, 300*eurbackgroundWindowSizeBottom)
