...
gen_units_list_default = {
    ...
    ["sicily"] = {
        ["T1"] = {
            [0] = "Territorial Watchmen",
            [1] = "Territorial Swordsmen",
            [2] = "Territorial Guardsmen",
        },
        ["T2"] = {
            [0] = "Gondor Spearmen",
            [1] = "Gondor Infantry",
    ...
    ["normans"] = {
        ["T1"] = {
            [0] = "Blue Crag Dual",
            [1] = "Blue Crag Slingers",
            [2] = "Blue Crag Goblin Spears",
        },
        ["T2"] = {
            [0] = "Teraig Slingers",
            [1] = "Teraig Infantry",
            [2] = "Blue Crag Warg Warriors",
        },
        ["T3"] = {
            [0] = "Blue Crag Berserkers",
            [1] = "Blue Crag Warg Riders",
            [2] = "Blue Crag Bodyguards",
        },
        ["special"] = {
            "Blue Crag Berserkers",
        },
    },
    ["russia"] = {
        ["T1"] = {
    ...
    ["timurids"] = {
        ...
        ["T3"] = {
            [0] = "Framsguard Dismounted Axemen",
            [1] = "Framsguard Dismounted Spearmen",
    ...
    ["norway"] = {
        ["T1"] = {
            [0] = "Khazad Sentries",
            [1] = "Khazad Volunteers",
            [2] = "Dwarven Travellers",
        },
        ["T2"] = {
            [0] = "Legion Shieldguard",
            [1] = "Legion Crossbows",
            [2] = "Legion Shieldguard",
        },
        ["T3"] = {
    ...
    ["hungary"] = {
        ["T1"] = {
            [0] = "Ered Luin Militia",
            [1] = "Ered Luin Militia Spearmen",
            [2] = "Ered Luin Scouts",
        },
        ["T2"] = {
            [0] = "Longbeard Spearmen",
            [1] = "Longbeard Javelins",
            [2] = "Longbeard Crossbows",
        },
        ["T3"] = {
            [0] = "Sons of the Fallen",
            [1] = "Gabilgathol Guard",
            [2] = "Broadbeam Marksmen",
        },
        ["special"] = {
            "Azaghals Tomb Protectors",
        },
    },
    ["moors"] = {
        ["T1"] = {
            [0] = "Erebor Infantry",
            [1] = "Iron Hills Mattocks",
            [2] = "Erebor Axethrowers",
        },
        ["T2"] = {
            [0] = "Kings Axes",
            [1] = "Kings Warriors",
    ...
    ["ireland"] = {
        ...
        ["T3"] = {
            [0] = "Hitherbin",
            [1] = "Galadhrim Swordsmen",
            [2] = "Elbereths Sentinels",
        },
        ["special"] = {
            "Berio I Ngelaidh",
        },
    ...
    ["gundabad"] = {
        ...
        ["T2"] = {
            ...
            [2] = "Blackshield Archers",
        },
        ["T3"] = {
            [0] = "Mountain Guard",
            [1] = "Pale Uruks Glaives",
            [2] = "Wolfguard Sentinel",
        },
        ["special"] = {
            "Orc Avengers",
        },
    ...
    ["egypt"] = {
        ["T1"] = {
            [0] = "Gathring Shieldbearers",
            [1] = "Daerbor Archers",
        },
        ["T2"] = {
            [0] = "Doross Archers",
            [1] = "Dagnir Swordmasters",
            [2] = "Feanturi Halberdiers",
        },
        ["T3"] = {
            [0] = "Ost-in-Edhil Champions",
            [1] = "Guardians of Eregion",
            [2] = "Realm Sentinels",
        },
        ["special"] = {
            "Carnil Sharpshooters",
        },
    },
    ["papal_states"] = {
        ["T1"] = {
